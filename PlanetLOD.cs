...
//       var noise1 = perlinNoise3D.GenerateNoiseValue(position.X * 0.1f, position.Y * 0.1f, position.Z * 0.1f) * 4f;
//       var noise2 = perlinNoise3D.GenerateNoiseValue(position.X * 0.3f, position.Y * 0.3f, position.Z * 0.3f) * 1f;
